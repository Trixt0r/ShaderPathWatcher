...
public class ShaderUtils {
	...
	public static FloatBuffer getFloatBufferForType(int type){
		...
		default: return BufferUtils.newFloatBuffer(1);
		}
	}
	
	public static void setUniformf(int location, int type, FloatBuffer buffer){
		switch(type){
		case GL_FLOAT: Gdx.gl20.glUniform1fv(location, buffer.capacity(), buffer);break;
		...
		//case GL_SAMPLER_2D: System.out.println(location); break;
		default: break;
		}
	}
